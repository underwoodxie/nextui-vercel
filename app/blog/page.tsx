...
export const metadata: Metadata = {
  title: '【無料】「猫ミーム」作り方を解説',
  description:"「猫ミーム」作り方を解説 1.Capcutアプリをダウンロード 2. 新しいプロジェクトを開始 3. 猫ミーム素材を集める 4. 動画を編集 5. 動画を完成させる"
};
...
export default async function Page() {
    ...
    <h1 className="text-3xl font-bold text-center mb-4">猫ミーム動画を作る簡単な手順</h1>
    ...
    <h2 className="text-2xl font-bold mt-4">5. 動画を完成させる</h2>
